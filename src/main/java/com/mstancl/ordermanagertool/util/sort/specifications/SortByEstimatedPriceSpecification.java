...
public class SortByEstimatedPriceSpecification implements Specification<Order> {

    @Override
    public boolean isSatisfied(List<Order> items) {
        return Comparators.isInOrder(items, Comparator.comparing(Order::getEstimatedPrice));
    }
}
*/
